  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        {
          path: '/admin/apps/tasklist',
          name: 'tasklist',
          component: () => import('@/views/apps/tasklist/Index.vue')
        },
        {
          path: '/admin/apps/mail',

          component: () => import('@/views/apps/mail/Index.vue'),
          children: [
            {
              path: '/admin/apps/mail/inbox',
              name: 'mail-inbox',
              component: () => import('@/views/apps/mail/MailTypes.vue')
            },
            {
              path: '/admin/apps/mail/compose',
              name: 'mail-compose',
              component: () => import('@/views/apps/mail/ComposeNew.vue')
            },
            {
              path: '/admin/apps/mail/detail/:id',
              name: 'mail-detail',
              component: () => import('@/views/apps/mail/Detail.vue')
            },
            {
              path: '/admin/apps/mail/starred',
              component: () => import('@/views/apps/mail/MailTypes.vue')
            },
            {
              path: '/admin/apps/mail/spam',
              component: () => import('@/views/apps/mail/MailTypes.vue')
            },
            {
              path: '/admin/apps/mail/important',
              component: () => import('@/views/apps/mail/MailTypes.vue')
            },
            {
              path: '/admin/apps/mail/sent',
              component: () => import('@/views/apps/mail/MailTypes.vue')
            },
            {
              path: '/admin/apps/mail/archived',
              component: () => import('@/views/apps/mail/MailTypes.vue')
            },
            {
              path: '/admin/apps/mail/trash',
              component: () => import('@/views/apps/mail/MailTypes.vue')
            }
          ]
        },
        ...
        },
        {
          ...
          children: [
            ...
            {
              path: '/admin/uikit/menu/confirmation',
              meta: {
        ...
        {
          path: '/admin/ecommerce/product-overview',
        ...
        {
          path: '/admin/ecommerce/new-product',
          name: 'new-product',
          meta: {
        ...
        {
          path: '/admin/ecommerce/shopping-cart',
          name: 'shopping-cart',
          meta: {
        ...
        {
          path: '/admin/ecommerce/checkout-form',
          name: 'checkout-form',
          meta: {
        ...
        {
          path: '/admin/ecommerce/order-history',
          name: 'order-history',
          meta: {
        ...
        {
          path: '/admin/ecommerce/order-summary',
          name: 'order-summary',
          meta: {
