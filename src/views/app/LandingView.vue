<template>
    ...
    <div class="flex flex-col items-center">
      ...
      >
        <template #item="slotProps">
          <img :src="slotProps.item.imageUrl" :alt="slotProps.item.alt" style="width: 100%; display: block" />
        </template>
      </Galleria>
    </div>
  </ContentSection>
  ...
  <ContentSection id="rsvp" variant="secondary" title="Reserve um minuto e confirme sua presença.">
    <div class="text-center">
      <RouterLink to="/rsvp">
        <Button outlined>Confirmar presença</Button>
      </RouterLink>
    </div>
  </ContentSection>
  <ContentSection variant="primary">
    <p class="text-center">Site feito com ❤️</p>
  </ContentSection>
</template>
...
onMounted(() => {
  images.value = [
    {
      imageUrl: '/imgs/ensaio/ensaio_01.jpg',
      alt: 'Ensaio 01'
    },
    {
      imageUrl: '/imgs/ensaio/ensaio_02.jpg',
      alt: 'Ensaio 02'
    },
    {
      imageUrl: '/imgs/ensaio/ensaio_03.jpg',
      alt: 'Ensaio 03'
    },
    {
      imageUrl: '/imgs/ensaio/ensaio_04.jpg',
      alt: 'Ensaio 04'
    },
    {
      imageUrl: '/imgs/ensaio/ensaio_05.jpg',
      alt: 'Ensaio 05'
    },
    {
      imageUrl: '/imgs/ensaio/ensaio_06.jpg',
      alt: 'Ensaio 06'
    },
    {
      imageUrl: '/imgs/ensaio/ensaio_07.jpg',
      alt: 'Ensaio 07'
    },
    {
      imageUrl: '/imgs/ensaio/ensaio_08.jpg',
      alt: 'Ensaio 08'
    },
    {
      imageUrl: '/imgs/ensaio/ensaio_09.jpg',
      alt: 'Ensaio 09'
    }
  ]
})
